...
$tag_1 = $_POST['tag1'];
$tmp = mysqli_query($con,("SELECT id FROM cms_tags WHERE tag = '".FilterText($tag_1)."'") or die(mysql_error());
$tag_1_results = mysql_num_rows($tmp);
$tag_2 = $_POST['tag2'];
$tmp = mysqli_query($con,("SELECT id FROM cms_tags WHERE tag = '".FilterText($tag_2)."'") or die(mysql_error());
