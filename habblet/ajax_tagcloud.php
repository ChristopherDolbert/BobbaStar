...
} elseif (!defined("IN_HOLOCMS")) {
	exit;
}

// Récupérer les tags et le nombre d'occurrences
$result = $bdd->query("SELECT tag, COUNT(id) AS quantity FROM cms_tags GROUP BY tag ORDER BY rand() LIMIT 20");
