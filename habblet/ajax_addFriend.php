...
$stmt1->execute([':id' => $id, ':my_id' => $user['id']]);
...
$stmt2->execute([':my_id' => $user['id'], ':id' => $id]);
...
$stmt3->execute([':my_id' => $user['id'], ':id' => $id]);
...
$stmt4->execute([':my_id' => $user['id'], ':id' => $id]);
...
if (!$error) {
	...
	$insert->execute([':my_id' => $user['id'], ':id' => $id, ':requestid' => $requestid]);
