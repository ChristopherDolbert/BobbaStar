...
<?php
$get_rooms = mysqli_query($con,("SELECT id,name,introduction,hconly,disclaimer_text FROM cms_application_forms WHERE deleted='0'") or die(mysql_error());
