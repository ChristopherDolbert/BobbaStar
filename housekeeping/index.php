...
if (isset($_SESSION['acp'])) {
	...
	$query = "SELECT id, rank, password FROM users WHERE username = :username AND rank > 5 LIMIT 1";
	...
	$valid = $stmt->rowCount();
	if ($valid > 0 && password_verify($admin_password, $check['password'])) {

		$user_rank = $check['rank'];
