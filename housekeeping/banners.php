...
if(isset($_POST['add'])) {
	mysqli_query($con,("INSERT INTO cms_banners (text,banner,url,status,advanced,html) VALUES ('".$_POST['text']."','".$_POST['banner']."','".$_POST['url']."','".$_POST['status']."','".$_POST['advanced']."','".FilterText($_POST['html'])."')");
	$msg = "Action succesfull!";
	}
	
	if(isset($_POST['edit'])) {
	mysqli_query($con,("UPDATE cms_banners SET text='".$_POST['text']."',banner='".$_POST['banner']."',url='".$_POST['url']."',status='".$_POST['status']."',advanced='".$_POST['advanced']."',html='".FilterText($_POST['html'])."' WHERE id='".$_POST['id']."'");
	$msg = "Action succesfull!";
	}
	
	if(isset($_POST['delete'])) {
	mysqli_query($con,("DELETE FROM cms_banners WHERE id='".$_POST['id']."'");
	$msg = "Action succesfull!";
	}
...
$sql = mysqli_query($con,("SELECT * FROM cms_banners");
...
<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<?php if(isset($_GET['a'])) {
$sql = mysqli_query($con,("SELECT * FROM cms_banners WHERE id='".$_GET['a']."'");
...
<?php }else{
$sql = mysqli_query($con,("SELECT * FROM cms_banners WHERE id='".$_GET['d']."'");
$row = mysql_fetch_assoc($sql);
if(isset($_POST['delete'])) { ?>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b><?php echo $msg; ?></b></div></td>
