...
$msg = "Optimizing tables..</strong>";
$getTables = mysqli_query($con,("SHOW TABLES FROM " . $sqldb) or die(mysql_error());
    while($tmp = mysql_fetch_array($getTables)){
        $table = $tmp[0];
        $msg = $msg . "<br />Optimizing table " . $tmp[0] . "..";
        mysqli_query($con,("OPTIMIZE TABLE " . $tmp[0]) or die(mysql_error());
