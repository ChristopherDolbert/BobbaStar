...
if(isset($_POST['query'])){
	...
	$get_users = mysqli_query($con,("SELECT id,name,email,ipaddress_last,hbirth FROM users WHERE ipaddress_last = '" . FilterText($_POST['query']) . "' ORDER BY name ASC") or die(mysql_error());
