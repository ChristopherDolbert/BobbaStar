...
if($_GET['a'] == "delete"){
mysqli_query($con,("DELETE FROM cms_collectables WHERE id = '".$_GET['key']."'");
...
mysqli_query($con,("UPDATE cms_collectables SET title='".$_POST['title']."',description='".$_POST['description']."',image_small='".$_POST['furni_image_small']."',image_large='".$_POST['furni_image_big']."',year='".$_POST['year']."',month='".$_POST['month']."',tid='".$_POST['tid']."' WHERE id='".$_GET['key']."' LIMIT 1") or die(mysql_error());
$msg = "Succesfully modified!";
}elseif(isset($_POST['add'])) {
mysqli_query($con,("INSERT INTO cms_collectables (title,image_small,image_large,tid,description,month,year) VALUES ('".$_POST['title']."','".$_POST['furni_image_small']."','".$_POST['furni_image_big']."','".$_POST['tid']."','".$_POST['description']."','".$_POST['month']."','".$_POST['year']."')") or die(mysql_error());
...
<?php }elseif($_GET['a'] == "edit") {
		if(isset($_GET['key'])) {
		$sql = mysqli_query($con,("SELECT * FROM cms_collectables WHERE id='".HoloText($_GET['key'])."' LIMIT 1");
