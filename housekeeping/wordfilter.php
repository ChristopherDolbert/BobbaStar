...
if(isset($_POST['wordfilter_enable'])){
	...
	if(!empty($wordfilter_censor)){
		...
		mysqli_query($con,("UPDATE system_config SET sval = '".$wordfilter_enable."' WHERE skey = 'wordfilter_enable' LIMIT 1") or die(mysql_error());
		mysqli_query($con,("UPDATE system_config SET sval = '".$wordfilter_censor."' WHERE skey = 'wordfilter_censor' LIMIT 1") or die(mysql_error());

		$msg = "Settings saved successfully.";

		mysqli_query($con,("INSERT INTO system_stafflog (action,message,note,userid,targetid,timestamp) VALUES ('Housekeeping','Updated Server Settings (Wordfilter Options)','wordfilter.php','".$my_id."','','".$date_full."')") or die(mysql_error());
