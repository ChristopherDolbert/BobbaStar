...
<body>
	...
	<div id='ipdwrapper'><!-- IPDWRAPPER -->
		...
		<div class='tabwrap-main'>
			<div class='tab<?php if ($tab == 1) {
								echo "on";
							} else {
								echo "off";
							} ?>-main'><img src='images/dashboard.png' style='vertical-align:middle' /> <a href='index.php?p=dashboard'>Acceuil</a></div>
			<div class='tab<?php if ($tab == 2) {
								echo "on";
							} else {
								echo "off";
							} ?>-main'><img src='images/system.png' style='vertical-align:middle' /> <a href='index.php?p=server'>Serveur</a></div>
			<div class='tab<?php if ($tab == 3) {
								echo "on";
							} else {
								echo "off";
							} ?>-main'><img src='images/tools.png' style='vertical-align:middle' /> <a href='index.php?p=site'>Site & Contenue</a></div>
			<div class='tab<?php if ($tab == 5) {
								echo "on";
							} else {
								echo "off";
							} ?>-main'><img src='images/admin.png' style='vertical-align:middle' /> <a href='index.php?p=users'>Utilisateur</a></div>


			<div class='logoright'><br />
