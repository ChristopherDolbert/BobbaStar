...
if(isset($_GET['key'])) {
	...
	mysqli_query($con,("UPDATE rooms SET password='".$_POST['password']."',name='".$_POST['name']."',model='".$_POST['model']."',ccts='".$_POST['ccts']."',floor='".$_POST['floor']."',wallpaper='".$_POST['wallpaper']."',description='".$_POST['description']."',state='".$_POST['state']."',visitors_now='".$_POST['visitors_now']."',visitors_max='".$_POST['visitors_max']."' WHERE id='".$_GET['key']."'") or die(mysql_error());
...
$sql = mysqli_query($con,("SELECT * FROM rooms WHERE id='".$_GET['key']."' AND owner IS NULL LIMIT 1");
