...
if($do == "save" && isset($_POST['topstory'])){
	...
	mysqli_query($con,("INSERT INTO cms_news (title,category,topstory,short_story,story,author,date) VALUES ('".$title."','".$category."','".$topstory."','".$short_story."','".$story."','".$name."','".$date_reversed."')") or die(mysql_error());
