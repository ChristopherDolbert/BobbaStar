...
<body>
    ...
    <table>
        <tbody>
            ...
            ?>
                <tr class="bas">
                    <td class="bas"><?PHP echo $a['pseudo'] ?></center>
                    </td>
                    <td class="bas"><?PHP echo $a['date'] ?></center>
                    </td>
                    <td class="bas"><?PHP echo $a['age'] ?></center>
                    </td>
                    <td class="bas">
                    ...
                    <td class="bas"><a href="#" onclick="newPopup('<?PHP echo $url ?>/managements/aff_histo_recrut?pseudo=<?PHP echo $a['pseudo'] ?>', 'Historique des candidatures');return false;">Historique</a> - <a href="?id=<?PHP echo $a['id_recrut'] ?>&&do2=<?PHP echo $a['id'] ?>">Accepté</a> - <a href="?id=<?PHP echo $a['id_recrut'] ?>&&do=<?PHP echo $a['id'] ?>">Refuser</a></center>
                    </td>
                </tr>
            <?PHP } ?>
        </tbody>
        ...
        <tbody>
            ...
            ?>
                <tr class="bas">
                    ...
                    <td class="bas"><?PHP echo $modif_traite ?></center>
                    </td>
                    <td class="bas"><?PHP echo $a['traite_par'] ?></center>
                    </td>
                </tr>
            <?PHP } ?>
        </tbody>
