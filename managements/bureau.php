...
<div id="article_haut"><span style="width: 64px; height: 83px; margin-top:-5px; margin-left:-5px; float: left; background: url(https://avatar.myhabbo.fr/?figure=<?PHP echo Secu($r['look']); ?>&action=wav&direction=2&head_direction=2&gesture=sml&size=big&img_format=gif);"></span><br/><span style="color: #000000; font-size: 11px;"><br/><b>Dernière modification effectuée par :</b> <?PHP echo Secu($n['par']); ?><br/><b>Date :</b> <?PHP echo Secu($n['date']); ?><br/><br/></div>  
</div> 
</div></div></div></div></div>
<div id="container"> 
