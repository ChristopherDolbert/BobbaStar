                    ...
                    <div class="cbb clearfix brown">
                        ...
                        <div class="box-content">
                            ...
                            <table width="100%">
                                <tbody>
                                    <tr>
                                        <td valign="top">Pseudo du demandeur : <b><?PHP echo Secu($t['pseudo']); ?></b> - <a href="<?PHP echo $url; ?>/info?tag=<?PHP echo Secu($t['pseudo']); ?>" target="_blank">Aller sur son profil &raquo;</a><br />
