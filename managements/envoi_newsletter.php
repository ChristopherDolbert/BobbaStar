...
<td width='80%' class='tbl'><input type="text" name="titre" value="<?php  if (!empty($_POST["titre"])) {  echo htmlspecialchars($_POST["titre"],ENT_QUOTES);  } ?>" class="text" style="width: 240px"><br/></td>
<br/>
...
<input type='submit' name='submit' value='Envoyer aux abonné(e)s' class='submit'></form>
