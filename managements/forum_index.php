...
<div class="cbb clearfix brown"><h2 class="title" style="background-color:#00C100">Topics signalés</h2> 
...
<div class="habblet-container" id="okt" style="float:left; width: 770px;">        
<div class="cbb clearfix darkred"><h2 class="title" style="background-color:#FF3E3E">Commentaires signalés</h2> 
 <div class="box-content"> 
<table>
<tbody>
<tr class="haut">
