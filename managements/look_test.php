	...
	<body>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			<tbody>
				...
				<tr>
					<td rowspan="2" style="background-color: #C0C0C0; border-color: rgb(0, 0, 0); text-align: left; vertical-align: top;"><span style="font-size:12px">
							<div style="overflow-y:auto; max-height:100px;"><?PHP echo nl2br(stripslashes($modif_z['avistuteur_commentaire'])); ?></div>
						</span></td>
					<td rowspan="2" style="background-color: #C0C0C0; border-color: rgb(0, 0, 0); text-align: left; vertical-align: top;"><span style="font-size:12px">
							<div style="overflow-y:auto; max-height:100px;"><?PHP echo nl2br(stripslashes($modif_z['avisdir_commentaire'])); ?></div>
						</span></td>
				</tr>
			</tbody>
		</table><br /><br />
