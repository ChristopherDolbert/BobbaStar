...
if (isset($_GET['sup'])) {
    ...
    if ($sup != "") {
        ...
        if ($assoc2['gender'] == 'M') {
            $insertn1->bindValue(':action', 'a déstitué <b>' . $assoc2['username'] . '</b> de son poste de <b>' . addslashes($c['nom_M']) . '</b>');
        } elseif ($assoc2['gender'] == 'F') {
            $insertn1->bindValue(':action', 'a déstitué <b>' . $assoc2['username'] . '</b> de son poste de <b>' . addslashes($c['nom_F']) . '</b>');
        }
        ...
        if ($assoc2['gender'] == 'M') {
            ...
            echo '<h4 class="alert_success"><b>' . $assoc2['username'] . '</b> a bien été destitué de son poste <b>(' . $c['nom_F'] . ')</b></h4>';
        }
    }
}
?>
