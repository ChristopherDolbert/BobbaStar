...
<td width='80%' class='tbl'><input type="text" name="nom_poste_m" value="<?php  if (!empty($_POST["nom_poste_m"])) {  echo htmlspecialchars($_POST["nom_poste_m"],ENT_QUOTES);  } ?>" class="text" style="width: 360px" /><br/></td>
<td width='100' class='tbl'><b>Nom du poste au féminin :</b><br/></td>
<td width='80%' class='tbl'><input type="text" name="nom_poste_f" value="<?php  if (!empty($_POST["nom_poste_f"])) {  echo htmlspecialchars($_POST["nom_poste_f"],ENT_QUOTES);  } ?>" class="text" style="width: 360px" /><br/></td>
<td width='100' class='tbl'><b>Nom du poste dans les NDS :</b> (suffit de mettre un S à la fin)<br/></td>
<td width='80%' class='tbl'><input type="text" name="nom_poste_nds" value="<?php  if (!empty($_POST["nom_poste_nds"])) {  echo htmlspecialchars($_POST["nom_poste_nds"],ENT_QUOTES);  } ?>" class="text" style="width: 360px" /><br/></td>
...
<?PHP } ?>
		...
		<input type="submit" value="Ajouter" /></form><br/><hr/>
...
<?PHP } ?>
	...
	<br/><input type="submit" value="Déplacer" /></form><br/>
<?PHP } ?>
