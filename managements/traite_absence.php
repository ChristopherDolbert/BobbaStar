            ...
            <tbody>
                ...
                ?>
                    <tr class="bas">
                        ...
                        <td class="bas"><a href="?modif=<?PHP echo $a['id']; ?>"><img src="<?PHP echo $url; ?>/managements/img/images/invalide.gif" /></a> - <a href="?do=<?PHP echo $a['id']; ?>"><img src="<?PHP echo $url; ?>/managements/img/images/valide.gif" /></a></center>
                        </td>
                    </tr>
                <?PHP } ?>
            </tbody>
