...
Donnes au nombre de personnes de ton choix, <b>1</b> code qui lui servira &agrave; gagner des jetons en rentrant le code depuis la page jetons du site.<br /><br />
<form name='editor' method='post' action="?do=massjetons">
	...
	<select name="jetons" id="jetons" class="select">
		...
		<option value="30">30 jetons</option>
	</select><br />
	<tr>
		...
		<td align='center' colspan='2' class='tbl'>
			<input type='submit' name='submit' value='Créer' class='submit'>
</form>
</tr><br />
<hr /><br />
<?php
...
<td class="haut">Historique</td>
	...
	while ($n = $sql->fetch()) {
		...
		if ($n['valid'] == '0') {
			$valider = "Autant que veut la personne";
		}
		if ($n['valid'] == '1') {
			$valider = "Une fois par personne";
		}
?>
		<tr class="bas">
