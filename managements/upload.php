				...
				<div class="habblet-container" id="okt" style="float:left; width: 770px;">
					<div class="cbb clearfix green">
						...
						<div class="habblet box-content">
							Grâce à cet outil, vous pouvez uploader des images sur le serveur de <?PHP echo $sitename; ?>.<br /><br />
							<center>
								<?php
        ...
        <div class="redeem-error"> 
            <div class="rounded rounded-red"> Erreur, le dossier d\'upload n\'existe pas.
									...
									if (isset($erreur)) {
										...
										if ($_FILES['fichier']['type'] == 'image/bmp') {
											$extention = '.bmp';
										}
										if ($_FILES['fichier']['type'] == 'image/ico') {
											$extention = '.ico';
										}
