...
if (isset($_POST['bean_avatarName'])) {
    ...
    if (!$failure) {
        ...
        $badges = array("BE2", "HH1", "FAN"); // tableau contenant les codes de badges que vous voulez insérer
        $insertbadge = $bdd->prepare("INSERT INTO users_badges (user_id, badge_code) VALUES (?, ?)");
        foreach ($badges as $badge) {
            $insertbadge->execute([$userid, $badge]);
        }
                                                    ...
                                                    <?php if (isset($error['dob'])) { ?>
                                                        ...
                                                        <noscript>
                                                            <fieldset id="register-fieldset-captcha">
                                                                <div class="register-label"><img src="./captcha/CaptchaSecurityImages.php?width=170&height=40&characters=10" />
                                                                </div>
                                                                ...
                                                                <div class="register-label"><label for="register-captcha">Tape
                                                                        ...
                                                                        ci-dessus</label></div>
                                                                <div><input type="text" name="bean.captchaResponse" id="register-captcha-bubble" class="register-text-black" value="\" size="15">
                                                                </div>
                                                            </fieldset>
                                                        </noscript>
                                                        ...
                                                        <fieldset id="register-fieldset-terms">
                                                            <div class="rounded rounded-darkgray" id="register-terms">
                                                                <div id="register-terms-content">
                                                                    <p><a href="./papers/disclaimer.php" target="_blank" id="register-terms-link">Conditions
                                                                            d'utilisation</a></p>
                                                                    <p class="last">
