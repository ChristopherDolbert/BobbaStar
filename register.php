...
if (isset($_POST['bean_avatarName'])) {
    ...
    $captcha = $_POST['bean_captchaResponse'];
    ...
    if ($_SESSION['register-captcha-bubble'] == $captcha && !empty($_SESSION['register-captcha-bubble'])) {
...
<head>
    ...
    <meta name="description"
          content="<?php echo $sitename; ?> is a virtual world where you can meet and make friends."/>
    <meta name="keywords"
          content="<?php echo $shortname; ?>,<?php echo $sitename; ?>,virtual world,play games,enter competitions,make friends"/>
    ...
    <style type="text/css">
        body {
            behavior: url(https://bobbastar.fr/web-gallery/csshover.htc);
        }
    </style>
    <![endif]-->
        ...
        <div id="content">
            <div id="header" class="clearfix">
                ...
                <ul class="stats">
                    ...
                    <li class="stats-visited"><span class="stats-fig"><?= $nbUserInscrits ?></span> Joueurs inscrits
                    </li>
                </ul>
            </div>
                        ...
                        <form method="post" action="" id="registerform" autocomplete="off">
                            ...
                            <div id="register-column-left">
                                <div id="register-avatar-editor-title">
                                    <h2 class="heading"><span class="numbering white">1.</span>Cr&eacute;e ton Habbo!
                                    </h2>
                                </div>
                                ...
                                <div id="register-avatar-editor">
                                    <p><b>You don't Flash installed. This is why we can only show you a selection of
                                            pre-generated avatars. If you install Flash, you'll be able to choose from
                                            the hundreds of different options!</b></p>
                                    <h3>Girls</h3>
                                    <div class="register-avatars clearfix">
                                        <div class="register-avatar"
                                             style="background-image: url(<?php echo $avatarimage ?>hr-505-39.hd-626-1.ch-691-83.lg-705-67.sh-735-91.ha-1001-.ea-1401-84,s-0.g-1.d-4.h-4.a-0,b72abee33635a00982228c1f9215ae9a.gif)">
                                            <input type="radio" name="randomFigure"
                                                   value="F-hr-505-39.hd-626-1.ch-691-83.lg-705-67.sh-735-91.ha-1001-.ea-1401-84"
                                                   checked="checked"/>
                                        </div>
                                        <div class="register-avatar"
                                             style="background-image: url(<?php echo $avatarimage ?>hr-530-44.hd-615-10.ch-630-89.lg-705-67.sh-740-62.fa-1206-91.wa-2001-,s-0.g-1.d-4.h-4.a-0,161dda9150b648cd14ff1aa9d9dcc5ad.gif)">
                                            <input type="radio" name="randomFigure"
                                                   value="F-hr-530-44.hd-615-10.ch-630-89.lg-705-67.sh-740-62.fa-1206-91.wa-2001-"/>
                                        </div>
                                        <div class="register-avatar"
                                             style="background-image: url(<?php echo $avatarimage ?>hr-681-40.hd-629-1.ch-675-86.lg-700-78.sh-725-82,s-0.g-1.d-4.h-4.a-0,1aba810a364a5410115f463f6963f7e1.gif)">
                                            <input type="radio" name="randomFigure"
                                                   value="F-hr-681-40.hd-629-1.ch-675-86.lg-700-78.sh-725-82"/>
                                        </div>
                                    </div>
                                    <h3>Boys</h3>
                                    <div class="register-avatars clearfix">
                                        <div class="register-avatar"
                                             style="background-image: url(<?php echo $avatarimage ?>hr-105-34.hd-205-6.ch-878-78.lg-281-76.sh-906-67,s-0.g-1.d-4.h-4.a-0,469e46ac01e81f244eb50b4ca7a43520.gif)">
                                            <input type="radio" name="randomFigure"
                                                   value="M-hr-105-34.hd-205-6.ch-878-78.lg-281-76.sh-906-67"/>
                                        </div>
                                        <div class="register-avatar"
                                             style="background-image: url(<?php echo $avatarimage ?>hr-170-44.hd-207-9.ch-210-84.lg-285-75.sh-290-67,s-0.g-1.d-4.h-4.a-0,430994a364251faa1302b37ca50f6ea9.gif)">
                                            <input type="radio" name="randomFigure"
                                                   value="M-hr-170-44.hd-207-9.ch-210-84.lg-285-75.sh-290-67"/>
                                        </div>
                                        <div class="register-avatar"
                                             style="background-image: url(<?php echo $avatarimage ?>hr-145-33.hd-180-10.ch-250-91.lg-270-64.sh-290-75.ea-1406-,s-0.g-1.d-4.h-4.a-0,c52a0478283776654483107d0ca2a2fd.gif)">
                                            <input type="radio" name="randomFigure"
                                                   value="M-hr-145-33.hd-180-10.ch-250-91.lg-270-64.sh-290-75.ea-1406-"/>
                                        </div>
                                    </div>
                                    <p><input type="submit" name="refresh" value="Show more Habbos"
                                              id="register-avatars-refresh"/></p>
                                </div>
                            ...
                            <div id="register-column-right">
                                ...
                                <div id="register-section-3">
                                    ...
                                    <div class="cbb clearfix gray">
                                        <h2 class="title heading"><span class="numbering white">3.</span>TES DONNEES
                                        </h2>
                                        <div class="box-content">
                                            ...
                                            <div class="register-error">
                                                ...
                                                <fieldset id="register-fieldset-password">
                                                    <div class="register-label"><label for="register-password">Mon
                                                            nouveau mot de passe sera:</label></div>
                                                    <div class="register-label"><input type="password" name="password"
                                                                                       id="register-password"
                                                                                       class="register-text" size="25"
                                                                                       value=""/></div>
                                                    <div class="register-label"><label for="register-password2">Retape
                                                            ton mot de passe</label></div>
                                                ...
                                                <div class="register-error">
                                                    ...
                                                    <fieldset>
                                                        <div class="register-label"><label>Je suis n&eacute; le:</label>
                                                        </div>
                                                        <div id="register-birthday"><select name="bean.day"
                                                                                            id="bean_day"
                                                                                            class="dateselector">
                                                    ...
                                                    <fieldset>
                                                        <div class="register-label"><label for="register-email">Mon
                                                                adresse email:</label></div>
                                                        <div class="register-label"><input type="text" name="bean.email"
                                                                                           id="register-email"
                                                                                           class="register-text"
                                                                                           value="" size="25"
                                                                                           maxlength="48"/></div>
                                                        <div class="register-label"><label for="register-email2">Retape
                                                                ton adresse email</label></div>
                                                        <div class="register-label"><input type="text"
                                                                                           name="bean.retypedEmail"
                                                                                           id="register-email2"
                                                                                           class="register-text"
                                                                                           value="" size="25"
                                                                                           maxlength="48"/></div>
                                                    ...
                                                    <div id="register-marketing-box">
                                                        ...
                                                        <label for="bean_marketing">Oui, je souhaite recevoir les
                                                            nouveaut&eacute;s de l'h&ocirc;tel par email, y compris la
                                                            newsletter!</label>
                                                    </div>
                                                    <noscript>
                                                        <fieldset id="register-fieldset-captcha">
                                                            <div class="register-label"><img
                                                                        src="./captcha/CaptchaSecurityImages.php?width=170&height=40&characters=10"/>
                                                            </div>
                                                            ...
                                                            <div class="register-label"><label for="register-captcha">Tape
                                                                    le message de s&eacute;curit&eacute;
                                                                    ci-dessus</label></div>
                                                            <div><input type="text" name="bean.captchaResponse"
                                                                        id="register-captcha-bubble"
                                                                        class="register-text-black" value="\" size="15">
                                                            </div>
                                                        </fieldset>
                                                    </noscript>
                                                    ...
                                                    <fieldset id="register-fieldset-terms">
                                                        <div class="rounded rounded-darkgray" id="register-terms">
                                                            <div id="register-terms-content">
                                                                <p><a href="./papers/disclaimer.php" target="_blank"
                                                                      id="register-terms-link">Conditions
                                                                        d'utilisation</a></p>
                                                                <p class="last">
                                                                    <input type="checkbox"
                                                                           name="bean.termsOfServiceSelection"
                                                                           id="register-terms-check" value="true"/>
                                                                    <label for="register-terms-check">J'accepte les
                                            ...
                                            <div id="form-validation-error-box" style="display:none">
                                                <div class="register-error">
                                                    <div class="rounded rounded-red">
                                                        D&eacute;sol&eacute;, l'inscription &agrave; &eacute;chou&eacute;,
                                                        recommence!
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div id="register-buttons">
                                        <input type="submit" value="Poursuivre" class="continue"
                                               id="register-button-continue"/>
                                        <a href="index.php?registerCancel=true" class="cancel">Retour &agrave;
                                            l'accueil</a>
                                    </div>
                        </form>
                    </div>
