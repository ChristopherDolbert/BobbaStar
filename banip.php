...
$pagename = "Tu es bannis !";
$pageid = "banned";

$query = $bdd->prepare("SELECT * FROM bans WHERE value = :remote_addr");
$query->bindValue(':remote_addr', $_SERVER['REMOTE_ADDR']);
$query->execute();
$data = $query->fetch(PDO::FETCH_ASSOC);

$stamp_now = time();
$stamp_expire = $data['ban_expire'];
					...
					<div id="terms" class="box-content">
						...
						<div class="tos-item"><br /><br />
							<p>
								...
								Un <b>administrateur</b> (<?PHP echo Secu($data['added_by']); ?>) a banni ton adresse IP <span style="background-color: #CEE3F6; padding: 2px;"><?PHP echo $data['value']; ?></span> pour la raison suivante « <b><?PHP echo $data['reason'] ?></b> ».<br />
