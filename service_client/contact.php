...
<span style="color: #0099FF;">Qu'est-ce qui se passe ? </span><input type="text" name="sujet" style="width: 360px;" maxlength="250" value="<?php  if (!empty($_POST["sujet"])) {  echo htmlspecialchars($_POST["sujet"],ENT_QUOTES);  } ?>" /><br /><br />
