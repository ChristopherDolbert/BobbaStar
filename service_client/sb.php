...
<body>
	...
	<div style="display:block; position:fixed;" title="Quitter le service client" onmouseover="tooltip.show(this)" onmouseout="tooltip.hide(this)">
		<a href="<?PHP echo $url; ?>/moi"><img src="<?PHP echo $url; ?>/service_client/img/retour.gif" style="margin-left:10px;" /></a>
	</div>
	<div id="container">
		...
		<div id="mil">
			...
			<form method="post" action="#">
				...
				<span style="color: #4169E1;">Qu'est-ce qui se passe ? </span><input type="text" name="sujet" style="width: 360px;" maxlength="250" value="<?php if (!empty($_POST["sujet"])) {
