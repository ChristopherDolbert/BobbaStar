					...
					<div id="process-content">
						<div id="terms" class="box-content">
							...
							<div class="rounded rounded-blue">
								...
								<BIG>
									<center><b>Quelques petites règles</center></b>
								</BIG>
							</div>
							<div class="tos-item">
								...
								<p style="text-align: center;"><br /><img src="<?PHP echo $imagepath; ?>v2/images/rules.gif" align="center" /><br /><br /><b>
										<font color="black">Agit avec les autres utilisateurs comme tu voudrais qu'ils agissent avec toi.
									</b><br /> Et rappelle toi qu'un crime dans le monde virtuel est aussi sérieux qu'un crime dans le monde réel. <br />Merci de contacter un modérateur en cas de besoin.<br /><br /><u>Rappel:</u> Les utilisateurs ne respectant pas ces r&egrave;gles se verront exclu du site.</b></font>
								</p>
