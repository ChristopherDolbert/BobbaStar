...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/style.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/buttons.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/boxes.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/tooltips.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/personal.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <script src="<?PHP echo $imagepath; ?>static/js/habboclub.js" type="text/javascript"></script>
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/minimail.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <link rel="stylesheet"
              href="<?PHP echo $imagepath; ?>v2/styles/myhabbo/control.textarea.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
        <script src="<?PHP echo $imagepath; ?>static/js/minimail.js" type="text/javascript"></script>
        <script src="<?PHP echo $imagepath; ?>static/js/settings.js" type="text/javascript"></script>
        <link rel="stylesheet" href="<?PHP echo $imagepath; ?>v2/styles/settings.css<?php echo '?' . mt_rand(); ?>"
              type="text/css"/>
                    ...
                    <?php if (!IsHCMember($user['id'])) { ?>
                        <div class="cbb habboclub-tryout">
                            ...
                            <div class="box-content">
                                ...
                                <p class="habboclub-header">Le <?php echo $shortname; ?> Club est seulement pour les
                                    VIP's: c'est un max d'avantages, de v&ecirc;tements trop funs et surtout une console
                                    qui peut habiter plus de 600 amis!</p>
                                <p class="habboclub-link"><a href="club.php">Adh&egrave;res au <?php echo $shortname; ?>
                                        Club &gt;&gt;</a></p>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="cbb clearfix settings">
                        ...
                        <div class="box-content">
                            ...
                            <div id="settings-editor">
                                Pour te changer, il te faut Flash player d'Adobe: <a target="_blank"
                                                                                     href="http://www.adobe.com/go/getflashplayer">http://www.adobe.com/go/getflashplayer</a>
                            </div>
                            ...
                            <form method="post" action="profile.php?tab=1" id="settings-form" style="display: none">
                                ...
                                <input type="hidden" name="figureData" id="settings-figure"
                                       value="<?php echo $mylook1; ?>"/>
                                <input type="hidden" name="newGender" id="settings-gender"
                                       value="<?php echo $mysex1; ?>"/>
                                <input type="hidden" name="editorState" id="settings-state" value=""/>
                                <input type="hidden" name="bean.figure" id="settings-figure" value=""/>
                                <a href="#" id="settings-submit"
                                   class="new-button disabled-button"><b>Enregistrer</b><i></i></a>
            ...
            <div class="box-content">
                ...
                <form action="profile.php?tab=2" method="post">
                    ...
                    <p>
                        ...
                        <input type="text" name="motto" size="32" maxlength="32" value="<?php echo Secu($motto); ?>"
                               id="avatarmotto"/>
                    </p>
                    ...
                    <div class="settings-step">
                        ...
                        <div class="settings-step-content">
                            ...
                            <p>
                                ...
                                <input type="password" size="32" maxlength="32" name="password" id="currentpassword"
                        ...
                        <div class="settings-step-content">
                            ...
                            <p>
                                ...
                                <input type="text" name="email" id="email" size="32" maxlength="48"
                                       value="<?php echo $themail; ?>"/>
                            </p>

                            <p>
                                <input name="directemail" id="directemail" <?php echo $newsletter; ?> type="checkbox">
                                <label for="directemail">Oui, merci de m'envoyer les nouveaut&eacute;s de l'h&ocirc;tel
                                    par e-mail!</label>
                            </p>
    ...
    <div class="habblet-container " style="float:left; width: 560px;">
        <div class="cbb clearfix settings">
            ...
            <div class="box-content">
                ...
                <p>Tu es a cours de cr&eacute;dit? Les staffs sont super occup&eacute;s et t'en a vraiment besoin? Il
                ...
                <p><b>1. Donne &agrave; ton ami ton lien.</b><br/>En deux minutes, ton ami s'inscris via ton lien! Tes
                    cr&eacute;dits vont &ecirc;tre envoy&eacute;s automatiquement! Voici le lien:<br/>
                    <input type="text" size="80%" enabled="enabled" value="<?php if (!empty($path)) {
                        echo $path;
                    } ?>register.php?refer=<?php echo $rawname; ?>">
                </p>
                <p><b>2. Attendre que ton ami s'inscrive!</b><br/>Apr&egrave;s &ccedil;a, a toi les mobis branch&eacute;s
                    et deviens le plus riche de l'h&ocirc;tel!
            ...
            <div id="friend-management-container" class="box-content">
                ...
                <div id="category-options" class="clearfix">
                    ...
                    <div class="friend-del"><a class="new-button red-button cancel-icon" href="#"
                                               id="delete-friends"><b><span></span>Supprimer les amis s&eacute;lectionn&eacute;s</b><i></i></a>
                    </div>
                    <div class="friend-move"><a class="new-button" href="#" id="move-friend-button"><b><span></span>Retour</b><i></i></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cbb clearfix settings">
            ...
            <div class="box-content">
                <form action="profile.php?tab=8" method="post">
                    ...
                    <p>
                        <input type="radio" name="block_friendrequests"
                               value="1" <?php if ($row['block_friendrequests'] == "1") { ?> checked="checked" <?php } ?> />Oui
                        <input type="radio" name="block_friendrequests"
                               value="0" <?php if ($row['block_friendrequests'] == "0") { ?> checked="checked" <?php } ?> />Non
                    </p>

                    <h3>Ancien chat</h3>
                    <p>
                        <input type="radio" name="old_chat"
                               value="1" <?PHP if ($row['old_chat'] == "1") { ?> checked="checked" <?PHP } ?> />Ancien
                        <input type="radio" name="old_chat"
                               value="0" <?PHP if ($row['old_chat'] == "0") { ?> checked="checked" <?PHP } ?> />Nouveau
                    </p>

                    <h3>Bloquer les invitations d'appart</h3>
                    <p>
                        <input type="radio" name="block_roominvites"
                               value="1" <?PHP if ($row['block_roominvites'] == "1") { ?> checked="checked" <?PHP } ?> />Oui
                        <input type="radio" name="block_roominvites"
                               value="0" <?PHP if ($row['block_roominvites'] == "0") { ?> checked="checked" <?PHP } ?> />Non
                    </p>

                    <h3>Bloquer le suivi</h3>
                    <p>
                        <input type="radio" name="block_following"
                               value="1" <?PHP if ($row['block_following'] == "1") { ?> checked="checked" <?PHP } ?> />Oui
                        <input type="radio" name="block_following"
                               value="0" <?PHP if ($row['block_following'] == "0") { ?> checked="checked" <?PHP } ?> />Non
                    </p>
