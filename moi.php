...
<div id="container">
    ...
    <div id="habbo-plate">
			...
			<img src="http://www.habbo.co.uk/habbo-imaging/avatarimage?figure=<?php echo $user['look'];?>"> 
        </a>
    </div>
...
<div id="promo-box">	
	...
	$c = 0;
	while($news = $sql->fetch()) { $c++;
	?>
		<div class="promo-container" style="<?php if($c!= 1){ echo "display: none; ";}?> background-image: url(<?PHP echo $news['topstory_image'];?>);"> 
...
<div class="habblet-container ">		
						<div class="cbb clearfix red"><h2 class="title">Radio</h2> 

 <div class="box-content"> 
<object width="245" height="90"><param name="allowscriptaccess" value="always" /><param name="movie" value="http://static.radionomy.com/cdn/flash/BannerEmbed.swf?RadUID=9f28195c-0c1d-4698-b4e0-269cb5e9d5b9&amp;titlesColor=ffffff&amp;color=1c4a98&amp;autoPlay=yes&amp;lang=fr" /><param name="wmode" value="transparent" /><embed src="http://static.radionomy.com/cdn/flash/BannerEmbed.swf?RadUID=9f28195c-0c1d-4698-b4e0-269cb5e9d5b9&amp;titlesColor=ffffff&amp;color=1c4a98&amp;autoPlay=yes&amp;lang=fr" wmode="transparent" type="application/x-shockwave-flash" allowscriptaccess="always" width="245" height="90"></embed></object>
</div> 
					</div></div></div><script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script> </div>
<script type="text/javascript">
HabboView.run();
</script>
<!--[if lt IE 7]>
