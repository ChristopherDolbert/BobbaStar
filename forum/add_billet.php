...
<td width="80%" class="tbl"><input type="text" name="titre" value="<?php  if (!empty($_POST["titre"])) {  echo htmlspecialchars($_POST["titre"],ENT_QUOTES);  } ?>" class="text" style="width: 240px"><br/><br/></td>
...
<td width='80%' class='tbl'><textarea name='article' rows="10" id="editor1"><?php
...
<input type='submit' name='submit' value='Poster'></form>
</div></div>
</div></div>
</div></div>
<script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script>            
