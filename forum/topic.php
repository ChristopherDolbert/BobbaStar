...
<div class="habblet-container">		
<div class="cbb clearfix green"><h2 class="title">Les smileys</h2> 
<div class="box-content">
...
<?PHP
	...
	<div class="article-meta"><?PHP echo FullDate('full'); ?>
		<a href="<?PHP echo $url ?>/forum/topic">Introuvable</a></div> 
...
<div class="cbb clearfix green"><h2 class="title">Réactions (<?php $gabcms = "SELECT COUNT(*) AS id FROM gabcms_forum_commentaires WHERE id_topic = '".$n['id']."' AND etat != '2'";
            ...
            <tbody><tr> 
                    ...
                    <td valign="top">
                      <span style="color:<?PHP echo $modifier_r; ?>;"><b style="font-size: 110%;"><?PHP echo $as['username']; ?></span></b><span style="float: right; color:#000000;"><?PHP echo $vraie_date; ?> <a href="#" onclick="newPopup('<?PHP echo $url; ?>/forum/signale_commentaire?signale=<?PHP echo $a['id']; ?>', 'Signaler un commentaire');return false;">[signaler]</a></span> <br/>
                       <div id="cta_01"></div><div id="cta_02"><span><?PHP echo stripslashes(smileyforum($a['texte'])); ?></span></div><div id="cta_03"></div>
                    </td></tr></tbody> 
</table>
<?PHP }
...
<div class="cbb clearfix blue"><h2 class="title">Poste ton message</h2> 
...
<textarea name="commentaire" rows="4" id="editor1"><?php
 if (isset($_POST["commentaire"])) {
 echo htmlspecialchars($_POST["commentaire"],ENT_QUOTES);
 }
?></textarea>
<script>CKEDITOR.replace( 'editor1', { toolbar : 'Commentaireforum' });</script><br/>
...
<input type="submit" name="post_comment" value="Répondre" /></form>
</div>
</div></div> 
<?PHP } } ?>
<?PHP if($n['etat'] == 2) { ?><div class="habblet-container">		
<div class="cbb clearfix red"><h2 class="title">Topic fermé</h2> 
<div class="box-content">
