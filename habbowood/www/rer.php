...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<div style="margin:20px;padding:20px;background-color:#FFFFFF;">
		<h2>Error!</h2>
        <p>Please install <a href="http://www.macromedia.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash&amp;promoid=BIOX">Flash</a>.</p>
...
<script type="text/javascript">
	...
	fo.addVariable("language", "xx");
	fo.addVariable("base", "../");
	
	fo.addVariable("welcomeLink_0", "http://www.habbohotel.fi/habbo/fi/community/habbowood/");
	fo.addVariable("welcomeLink_1", "http://www.habbohotel.com/guerilla");
	fo.addVariable("welcomeLink_2", "http://www.habbohotel.fi/habbo/fi/community/habbowood/gala/");
	fo.addVariable("welcomeLink_3", "http://www.habbohotel.fi/habbo/fi/community/habbowood/rules/");

	fo.addVariable("introType", "0");
	fo.addVariable("voteOn","");	
	fo.addVariable("hotelLink","http%3A%2F%2Fwww.habbohotel.com%2Fhabbo%2Fuk%2Fcommon%2Fexternal%2Fpartner_registration%3Fisp%3Dminisite%26partner%3Dhabbowood2");	
...
var pUrl="http://www.habbohotel.xx/habbowood2.html";
var w0=1;
var refR=escape(document.referrer);
if (refR.length>=252) refR=refR.substring(0,252)+"..."; 
//--></script> 
<script language="JavaScript1.1" type="text/javascript"><!-- 
var w0=0; var rsUA=navigator.appName+" "+navigator.appVersion; var rsRUA=navigator.userAgent; var rsWS=window.screen; var rsBV=navigator.appVersion.substring(0, 1); var rsNN=(rsUA.indexOf('Netscape')); var rsMC=(rsUA.indexOf('Mac')); var rsIE=(rsUA.indexOf('MSIE')); var rsXP=(rsUA.indexOf('NT 5.1')); var rsCE=(rsUA.indexOf('Windows CE')); var rsLX=(rsUA.indexOf('Linux')); var rsOP=(rsRUA.indexOf('Opera')); var rsIEV=(parseInt(rsUA.substr(rsIE+5)));
var rsMSIE=false;var rsIE6=false;var rsOSXP=false;var rsIE6XP=false; var rsSW="na";var rsSH="na";var rsCD="na";var rsSR="na";var 
rsLG="na";var rsCT="na";var rsHP="na";var rsCK="na";var rsJE="na"; var rsJE=(navigator.javaEnabled()==true)?"y":"n";
...
var rsD= new Date();
var rsTZ=rsD.getTimezoneOffset()/-60; if((typeof(rsWS)!="undefined")&&(rsWS!=null)){
rsSW=rsWS.width;
rsSH=rsWS.height;
rsCD=rsWS.colorDepth;
if((rsNN!=-1)&&(rsBV >=4)){
rsCD=rsWS.pixelDepth;}}
if((rsNN!=-1)&&(rsBV >=4)||(rsOP>=0)){var 
rsLG=navigator.language;}if((rsIE!=-1)&&(rsBV >=4)&&(rsOP==-1)){var 
...
//--></script>
<script language="JavaScript" type="text/javascript"><!-- 
if(w0){ document.write('<img src="http://server-fi.imrworldwide.com/cgi-bin/count?url='+pUrl+'&ref='+ 
	refR+'&cid='+pCid + '" width="1" height="1">');
}
//-->
</script>
<noscript>
<img src="http://server-fi.imrworldwide.com/cgi-bin/count?url=http://www.habbohotel.xx/habbowood2.html&cid=fi_Habbohotel_0" width="1" height="1">
</noscript>
<!-- RedMeasure Ends --></body>
</html>
