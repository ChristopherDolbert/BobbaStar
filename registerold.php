...
<head>
    ...
    <link rel="alternate" type="application/rss+xml" title="Retro: RSS" href="https://phpretro.bobbastar.fr/rss" />
    ...
    <script type="text/javascript">
        ...
        var habboName = null;
        var ad_keywords = "";
        var habboReqPath = "https://phpretro.bobbastar.fr";
        var habboStaticFilePath = "https://phpretro.bobbastar.fr/web-gallery";
        var habboImagerUrl = "https://phpretro.bobbastar.fr/habbo-imaging/";
        var habboPartner = "";
    ...
    <script type="text/javascript">
        ...
        HabboView.add(function() {
            var swfobj = new SWFObject("https://phpretro.bobbastar.fr/flash/HabboRegistration.swf", "habboreg", "435", "400", "8");
            swfobj.addParam("base", "https://phpretro.bobbastar.fr/flash/");
            swfobj.addParam("wmode", "opaque");
            swfobj.addParam("AllowScriptAccess", "always");
            swfobj.addVariable("figuredata_url", "https://phpretro.bobbastar.fr/xml/figuredata.xml");
            swfobj.addVariable("draworder_url", "https://phpretro.bobbastar.fr/xml/draworder.xml");
            swfobj.addVariable("localization_url", "https://phpretro.bobbastar.fr/xml/figure_editor.xml");
            swfobj.addVariable("habbos_url", "https://phpretro.bobbastar.fr/xml/promo_habbos_v2.xml");
        ...
        <div class="cbb process-template-box clearfix">
            <div id="content">
                <div id="header" class="clearfix">
                    ...
                    <ul class="stats">
                        <li class="stats-online"><span class="stats-fig"><?PHP $count = $bdd->query("SELECT count(id) FROM users WHERE online = '1'");
                                                                            $counter = $count->fetch(PDO::FETCH_ASSOC);
                                                                            echo $counter['count(id)']; ?></span> Connectés</li>
                        <li class="stats-visited"><span class="stats-fig"><?PHP $register = $bdd->query("SELECT count(id) FROM users");
                                                                            $registered = $register->fetch(PDO::FETCH_ASSOC);
                                                                            echo $registered['count(id)']; ?></span> Joueurs inscrits</li>
                    </ul>
                </div>
                <div id="process-content">
                    ...
                    <div id="column1" class="column">
                        <div class="habblet-container ">
                            ...
                            <form method="post" action="registerold.php" id="registerform" autocomplete="off">
                                ...
                                <div id="register-column-left">
                                    <div id="register-avatar-editor-title">
                                        <h2 class="heading"><span class="numbering white">1.</span>Cr&eacute;e ton avatar</h2>
                                    </div>
                                ...
                                <div id="register-column-right">
                                    <div id="register-section-2">
                                        <div class="rounded rounded-blue">
                                            <h2 class="heading"><span class="numbering white">2.</span>Choisis ton nom</h2>

                                            <fieldset id="register-fieldset-name">
                                                <div class="register-label white">Ton nom <?php echo $shortname; ?></div>
                                                <input type="text" name="bean.avatarName" id="register-name" class="register-text" size="25" />
                                    ...
                                    <div id="register-section-3">
                                        ...
                                        <div class="cbb clearfix gray">
                                            <h2 class="title heading"><span class="numbering white">3.</span>D&eacute;tails sur toi</h2>
                                            <div class="box-content">
                                                ...
                                                <?php if (isset($error['password'])) { ?>
                                                    ...
                                                    <fieldset id="register-fieldset-password">
                                                        <div class="register-label"><label for="register-password">Mon mot de passe est:</label></div>
                                                        <div class="register-label"><input type="password" name="password" id="register-password" class="register-text" size="25" value="" /></div>
                                                        <div class="register-label"><label for="register-password2">Confirme-le:</label></div>
                                                    ...
                                                    <?php if (isset($error['dob'])) { ?>
                                                        ...
                                                        <fieldset>
                                                            <div class="register-label"><label>Je suis n&eacute;e le:</label></div>
                                                        ...
                                                        <fieldset>
                                                            <div class="register-label"><label for="register-email">Et mon e-mail est:</label></div>
                                                            <div class="register-label"><input type="text" name="bean.email" id="register-email" class="register-text" size="25" maxlength="48" /></div>
                                                            <div class="register-label"><label for="register-email2">Confirme-la:</label></div>
                                                        ...
                                                        <div id="register-marketing-box">
                                                            ...
                                                            <label for="bean_marketing">Oui, je shouaite recevoir des infos de <?php echo $shortname; ?> (Newsletters)</label>
                                                        </div>
                                                            ...
                                                            <div class="rounded rounded-darkgray" id="register-terms">
                                                                <div id="register-terms-content">
                                                                    ...
                                                                    <p class="last">
                                                                        ...
                                                                        <label for="register-terms-check">J'accepte les conditions.</label>
                                                                    <p>Je suis un <select name="beanBot">
                                                                            <option value="no">...</option>
                                                                            <option value="yes">un humain</option>
                                                    ...
                                                    <div id="form-validation-error-box" style="display:none">
                                                        <div class="register-error">
                                                            <div class="rounded rounded-red">
                                                                L'enregistrement n'a pas pu terminer, corriger les boxs en rouge.
                                                            </div>
                                                        </div>
                                                    </div>
                                            </div>
                                        ...
                                        <div id="register-buttons">
                                            <input type="submit" value="Jouer!" class="continue" id="register-button-continue" />
                                            <a href="index.php?registerCancel=true" class="cancel">Quittez l'enregistrement</a>
                                        </div>
                            </form>
                        </div>
                        <script type="text/javascript">
