...
if(isset($_GET['do'])) {
    $do = Secu($_GET['do']);
        if($do == "check") {
			...
			$bdd->query("UPDATE user_stats SET AchievementScore = AchievementScore + 1000 WHERE id = '".$user['id']."'");
        ...
        if($do == "check2") {
			...
			$bdd->query("UPDATE user_stats SET DailyRespectPoints = DailyRespectPoints + 300 WHERE id = '".$user['id']."'");
            $insertn1 = $bdd->prepare("INSERT INTO gabcms_transaction (user_id, produit, prix, gain, date) VALUES (:userid, :produit, :prix, :gain, :date)");
            $insertn1->bindValue(':userid', $user['id']);    
		...
		if($do == "check3") {
			...
			$bdd->query("UPDATE user_stats SET DailyRespectPoints = DailyRespectPoints + 700 WHERE id = '".$user['id']."'");
            $insertn1 = $bdd->prepare("INSERT INTO gabcms_transaction (user_id, produit, prix, gain, date) VALUES (:userid, :produit, :prix, :gain, :date)");
            $insertn1->bindValue(':userid', $user['id']);    
        ...
        if($do == "check4") {
			...
			$bdd->query("UPDATE user_stats SET DailyPetRespectPoints = DailyPetRespectPoints + 400 WHERE id = '".$user['id']."'");
            $insertn1 = $bdd->prepare("INSERT INTO gabcms_transaction (user_id, produit, prix, gain, date) VALUES (:userid, :produit, :prix, :gain, :date)");
            $insertn1->bindValue(':userid', $user['id']);    
        ...
        if($do == "check5") {
			...
			$bdd->query("UPDATE user_stats SET DailyPetRespectPoints = DailyPetRespectPoints + 900 WHERE id = '".$user['id']."'");
            $insertn1 = $bdd->prepare("INSERT INTO gabcms_transaction (user_id, produit, prix, gain, date) VALUES (:userid, :produit, :prix, :gain, :date)");
            $insertn1->bindValue(':userid', $user['id']);    
...
<?PHP if(isset($affichage)) { echo "<br/>".$affichage."<br/><br/>"; }?>
<div class="method idx0 m-smsma nosmallprint">
    <div class="method-content">
        <h2><font color="#F24987">RESPECTS</font></h2><div class="top"><div></div></div>

        <div class="summary clearfix">

            <ol>
<div>Ici, tu peux obtenir <b>300</b> ou bien <b>700</b> respects en un simple clique.<br/> Les respects te permettent de respecter les <?PHP echo $sitename; ?>iens, <br/>pour te faire un max d'amis.<br/>L'achat de respects est <b>payant</b>.<br/><h4><img src="<?PHP echo $imagepath;?>v2/images/attention.gif"> 300 = <?PHP echo $cp['respects_300'] ?> JETONS<br/><font color="#EDEDED">_-</font> 700 = <?PHP echo $cp['respects_700'] ?> JETONS</b></h4>
</div></ol>

<form name="editor" method="post" action="?do=check2"><input type="hidden" name="transactions_respects300" value="<?PHP echo $cp['respects_300'] ?>" /><center><input type="submit" name="submit" value="Acheter 300 respects" /></center> </form><br/>
<form name="editor" method="post" action="?do=check3"><input type="hidden" name="transactions_respects700" value="<?PHP echo $cp['respects_700'] ?>" /><center><input type="submit" name="submit" value="Acheter 700 respects" /></center> </form>
<br/></div></div>
...
<div class="method idx0 m-smsma nosmallprint">
    ...
    <div class="method-content">
        <h2><font color="#0ECA27">CARESSES</font></h2><div class="top"><div></div></div>

        <div class="summary clearfix">

            <ol>
<div>Ici, tu peux obtenir <b>400</b> ou bien <b>900</b> caresses en un simple clique.<br/> Les caresser te permettent de faire évoluer plus rapidement tes animaux en les caressant.<br/>L'achat de caresses est <b>payant</b>.<br/><h4><img src="<?PHP echo $imagepath;?>v2/images/attention.gif"> 400 = <?PHP echo $cp['caresses_400'] ?> JETONS<br/><font color="#EDEDED">_-</font> 900 = <?PHP echo $cp['caresses_900'] ?> JETONS</b></h4>
</div></ol>

<form name="editor" method="post" action="?do=check4"><input type="hidden" name="transactions_caresses_400" value="<?PHP echo $cp['caresses_400'] ?>" /><center><input type="submit" name="submit" value="Acheter 400 caresses" /></center> </form><br/>
<form name="editor" method="post" action="?do=check5"><input type="hidden" name="transactions_caresses_900" value="<?PHP echo $cp['caresses_900'] ?>" /><center><input type="submit" name="submit" value="Acheter 900 caresses" /></center> </form>
<br/></div></div>
...
<div class="method idx0 m-smsma nosmallprint">
    ...
    <br/><div class="method-content">
    <h2><font color="#30BFEA">WINWIN</font></h2><div class="top"><div></div></div>

        <div class="summary clearfix">           


            <ol>
<div>Ici, tu peux obtenir <b>1000</b> points winwin en un simple clique. Ils te permettront de frimer dans l'hôtel et de devenir le king des missions.<br/>L'achat de winwins est <b>payant</b>.<br/><h4><img src="<?PHP echo $imagepath;?>v2/images/attention.gif"> PRIX = <?PHP echo $cp['winwin'] ?> JETONS</h4>
</div></ol>     
<form name="editor" method="post" action="?do=check"><input type="hidden" name="transactions_winwin" value="<?PHP echo $cp['winwin'] ?>" /><center><input type="submit" name="submit" value="Acheter 1000 winwins" /></center> </form>
...
<div class="method idx0 m-smsma nosmallprint">
    ...
    <br/><div class="method-content">
    <h2><font color="#FED402">MESSAGE</font></h2><div class="top"><div></div></div>

        <div class="summary clearfix">           


            <ol>
<div>Ici, tu peux obtenir <b>30</b> messages afin de pouvoir poster plusieurs messages sur le tchat du jeu. L'achat de messages est <b>payant</b>.<br/><h4><img src="<?PHP echo $imagepath;?>v2/images/attention.gif"> PRIX = <?PHP echo $cp['messages'] ?> JETONS</h4>
</div></ol><br/>
<form name="editor" method="post" action="?do=check6"><input type="hidden" name="transactions_messages" value="<?PHP echo $cp['messages'] ?>" /><center><input type="submit" name="submit" value="Acheter 30 messages" /></center> </form>
<br/><br/>   </div>
    </div>
                    <div class="price">
                    <div>
                    <div>
			<div class="pricepoint-amount-container">
             <img src="<?PHP echo $imagepath;?>v2/images/divers/ZZZ.gif">
            </div></div></div></div></ol>
<div class="bottom">
