...
<head>
    ...
    <link rel="stylesheet" href="<?PHP echo $url; ?>/web-gallery/static/styles/cbs2credits.css<?php echo '?'.mt_rand(); ?>" type="text/css" />
    <link rel="stylesheet" href="<?PHP echo $url; ?>/web-gallery/static/styles/newcredits.css<?php echo '?'.mt_rand(); ?>" type="text/css" />
                        ...
                        <div class="method-group phone clearfix   cbs2">
                            ...
                            <div class="method idx0 m-smsma nosmallprint">
                                ...
                                <div class="method-content">
                                    <h2>
                                        <font color="#263778">VIP CLUB</font>
                                    </h2>
                                    <div class="top">
                                        <div></div>
                                    </div>
                                    <div class="summary clearfix">
                                        <ol>
                                            <div>Le VIP Club, c'est un club auquel, tu peux avoir certains avantages! <br /><br />Il te permet d'avoir plus de commandes, plus de mobis,<br />donc de mieux découvrir <?PHP echo $sitename; ?><br /><br />Chaque star de <?PHP echo $sitename; ?> est passée par le fameux VIP Club, <br />alors n'attends plus... Rejoins le.
                                                <br />
                                                <h3><b><br />
                                                        <img src="<?PHP echo $imagepath; ?>v2/images/attention.gif"> PRIX = <?PHP echo $cp['vipclub'] ?> JETONS</b></h3>
                                            </div>
                                        </ol>
                                        <form name="editor" method="post" action="?do=vipclub"><input type="hidden" name="transaction_vip" value="<?PHP echo $cp['vipclub'] ?>" />
                                            <center><input type="submit" name="submit" value="Adhérer au VIP CLUB" /></center>
                                        </form>
                                ...
                                <div class="price">
                                    <div>
                                        <div>
                                            <br />
                                            <div class="pricepoint-price-container">
                                                <font color="#5D658C">PROMO</font>
                                            </div>
                            ...
                            <div class="method idx0 m-smsma nosmallprint">
                                ...
                                <div class="method-content">
                                    <h2>
                                        <font color="#263778">AVANTAGES</font>
                                    </h2>
                                    <div class="top">
                                        <div></div>
                                    </div>
                    ...
                    <div class="cbb clearfix orange ">
                        ...
                        <div class="method-group phone clearfix   cbs2">
                            <div class="method idx0 m-smsma nosmallprint">
                                ...
                                <div class="method-content">
                                    <h2>
                                        <font color="#B02863">STAFF CLUB</font>
                                    </h2>
                                    <div class="top">
                                        <div></div>
                                    </div>
                                    <div class="summary clearfix">
                                        <ol>
                                            <div>Le STAFF club, c'est le plus grand <br />et le plus fun club de l'hôtel.<br /><br />Ce Club est <b>PAYANT</b>, car il permet d'avoir d'incroyables avantages, <br />des commandes et des mobis... comme de vrais Staffs!<br /><br />De plus, le staff club permet un avantage certain lors des recrut'...<br />Alors n'attends plus... Adhères-y!
                                                <br />
                                                <h3><b><br /><img src="<?PHP echo $imagepath; ?>v2/images/attention.gif"> PRIX = <?PHP echo $cp['staffclub'] ?> JETONS</b></h3>
                                        </ol>
                                        <form name="editor" method="post" action="?do=staffclub"><input type="hidden" name="transaction_staff" value="<?PHP echo $cp['staffclub'] ?>" />
                                            <center><input type="submit" name="submit" value="Adhérer au STAFF CLUB" /></center>
                                        </form>
                                        <div style="float: right; padding: 0 15px 15px 0; ">
                                            <br />
                                            </p>
                            ...
                            <div class="method idx0 m-smsma nosmallprint">
                                ...
                                <div class="method-content">
                                    <h2>
                                        <font color="#B02863">AVANTAGES</font>
                                    </h2>
                                    <div class="top">
                                        <div></div>
                                    </div>
