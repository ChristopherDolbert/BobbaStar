...
<?PHP echo $sitename;?> est actuellement en maintenance! Nous sommes désolés, mais Frank a fait tomber son café dans le serveur, nos techniciens sont en cours d'opération, voici les informations donnés par les staffs:
<br/><br/><div id="raison">
					<?php echo stripslashes($m['info']);?><br/><br/><i>Message de <b><?php echo stripslashes($m['auteur']);?></b> le <?php echo stripslashes($m['datestr']);?>.</i>
				</div>
...
<center><span style="color:#FF0000"><?PHP if(isset($erreur)) { echo "<br/>".$erreur.""; }?></span></center>
<script type="text/javascript"> 
    timedRedirect();
</script>
<script type="text/javascript"> 
