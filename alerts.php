...
<head>
	...
	<link rel="stylesheet" href="./web-gallery/pace.css">
									...
									<tbody>
										<tr>
											...
											<td valign="top"><span style="color:#778899;">Alerte envoyée le <u><?php echo Secu(stripslashes($alert['date'])); ?></u> par <b><?php echo Secu($alert['par']); ?></b>.</span><br />
												...
												<div id="cta_01"></div>
												<div id="cta_02"><span style="font-family: tahoma,arial,helvetica,sans-serif; color: #333333;"><b><?php echo Secu(stripslashes($alert['par'])); ?></b>:</span> <?php echo $alert['alerte']; ?></div>
												<div id="cta_03"></div>
												<br /><br />
