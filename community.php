...
<div class="habblet-container ">		
						<div class="cbb clearfix blue"><h2 class="title">Le dernier inscrit</h2> 
...
?></strong><br />
    Record de connect&eacute;s:&nbsp;<strong><?php 
...
<script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script></div><script type="text/javascript">if (!$(document.body).hasClassName('process-template')) { Rounder.init(); }</script> </div>
<!--[if lt IE 7]>
<script type="text/javascript">
