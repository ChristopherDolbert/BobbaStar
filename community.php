	...
	<div id="container">
		...
		<div id="content" style="position: relative" class="clearfix">
			<div id="promo-box">
                ...
                $sql->bindParam(1, $cof['nb_news'], PDO::PARAM_INT);
				$c = 0;
		...
		<div id="content" style="position: relative" class="clearfix">
			...
			<div id="column1" class="column">
                ...
                <input type=\"hidden\" id=\"active-habbo-url-%s\" value=\"" . $url . "/info?tag=%s\"/>
									...
									<tbody>
										<tr>
											<td valign="middle" width="10" height="60">
												<a href="<?PHP echo $url ?>/info?tag=<?PHP echo htmlentities($room['username']); ?>" title="Aller sur son profil &raquo;" onmouseover="tooltip.show(this)" onmouseout="tooltip.hide(this)">
											...
											<td valign="midle">
												<span style="color:#333333;"><b style="font-size: 110%;"><a href="<?PHP echo $url ?>/client?room=<?PHP echo $room['id'] ?>" onclick="openOrFocusHabbo(this); return false;" target="client"><?PHP echo htmlentities($room['name']); ?></a></span></b><br />
												<span style="color:#000000"><?PHP echo htmlentities($room['username']); ?></span><br />
											</td>
										</tr>
									</tbody>
								</table>
