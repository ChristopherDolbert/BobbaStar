...
<div id="footer">
	...
	<p class="copyright">
		...
		Habbo est une marque déposée de Sulake Corporation. Tous droits réservés &agrave; leur(s) propriétaire(s) respectif(s).<br />Nous ne sommes pas approuvés, affiliés ou offertes par Sulake Corporation LTD.<br><br><u>&copy; v<?PHP echo $version ?></u><br><br>
	</p>
</div>