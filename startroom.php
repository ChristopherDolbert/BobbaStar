                ...
                <div class="habblet-container ">
                    ...
                    <div style="background-color:white !important" class="cbb clearfix lightgreen">
                        ...
                        <div class="welcome-intro clearfix">
                            ...
                            <div style="padding-bottom:5px !important;text-align:center"
                                 id="welcome-intro-welcome-user"><?php echo $user['username']; ?>,
                                bienvenue <?php echo $sitename; ?>!
                            </div>
                            <div style="padding-top:0 !important;text-align:center" id="welcome-intro-welcome-party"
                                 class="box-content">Choisis ton appart et deviens officiellement propriétaire de ton
                                premier appart !
                            </div>
                        </div>
                ...
                <div class="habblet-container ">
                    <div class="cbb clearfix green ">
                        ...
                        <div class="welcome-shockwave clearfix box-content">
                            ...
                            <div id="welcome-shockwave-logo"><img src="web-gallery/v2/images/welcome/shockwave.gif"
                                                                  alt="shockwave"/></div>
                        </div>
